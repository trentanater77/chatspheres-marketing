    ...
    <PageWithSidebar initialSphere={featuredSphere}>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {spheres.length ? (
          ...
          <div className="rounded-[28px] border border-dashed border-[#22223B]/20 bg-white/70 p-6 text-sm text-[#22223B]/70 md:col-span-2">
            No spheres yet. Once you create one, it will appear here instantly thanks to Supabase polling.
          </div>
        )}
      </div>
